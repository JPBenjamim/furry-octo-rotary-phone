      ...
      <div className="cards">
        ...
        >
          <Card
            emoji={HeartEmoji}
            heading={"Suporte"}
            detail={"Não te abandonamos nunca, sempre a disposição para ajudar."}
          />
        </motion.div>
        {/* second card */}
        <motion.div
        ...
        >
          <Card
            ...
            detail={"Html, Css, JavaScript, React, WordPress, Hospedagem e dominios incluso."}
          />
        </motion.div>
        {/* 3rd */}
        <motion.div
        ...
        >
          <Card
            emoji={Humble}
            heading={"Alta conversão"}
            detail={
              "Nossas paginas são pensadas para oferecer altas conversões"
            }
